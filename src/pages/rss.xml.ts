...
export async function GET() {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>The Construct</title><description>Software architecture, security, and engineering notes.</description><link>${siteUrl}/</link>${items}</channel></rss>`;
